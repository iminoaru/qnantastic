...
function NavLinks() {
    return (
        <>
            ...
            <Link href="/playlists" className="nav_link w-inline-block">
                <div className="text-block-23">playlists</div>
                <div className="nav_navigation-tag">Navigation</div>
            </Link>
            <Link href="/pricing" className="nav_link w-inline-block">
                <div className="text-block-23">PRICING</div>
                <div className="nav_navigation-tag">Navigation</div>
            </Link>
            <Link href="/register" className="nav_link join w-inline-block">
